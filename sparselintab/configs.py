...
def build_parser():
    ...
    parser.add_argument(
        ...
        help='Checkpointing -- determines if there is no checkpointing '
             ...
             'maintained (all_checkpoints). See sparselintab/utils/eval_utils.py.')
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help='Model optimizer: see sparselintab/optim.py for options.')
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help='Learning rate scheduler: see sparselintab/optim.py for options.')
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help='Specifies a scheduler for the tradeoff between augmentation '
             'and label losses. See sparselintab/optim.py.')
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str, help=f'Different types of interaction debuging: '
                       ...
                       f'This again will confuse k-NN but sparselintab should be able to learn it.'
    )
    ...
    parser.add_argument(
        ...
        default='sparselintab',  # in {sparselintab, sklearn-baselines, DKL, ...}
    ...
    parser.add_argument(
        ...
        default=False,
        type=int,
        help=f'If using sparselintab for images, use image patching to handle high '
    ...
    # -------------------------------------------------------------------------------------------------
    # 关于LinFormer的一些参数
    parser.add_argument(  # 参数共享方式选择
        '--parameter_sharing',
        default='layerwise',
        type=str,
        help=f' introduce parameter sharing between projections.'
    )
    parser.add_argument(  # 行注意力机制的投影矩阵嵌入维度
        '--dimk_row',
        default=128,
        type=int,
        help=f'Embedding Dimension of Projection Matrix for Row Attention Mechanism'
    )
    parser.add_argument(  # 列注意力机制的投影矩阵嵌入维度
        '--dimk_col',
        default=8,
        type=int,
        help=f'Embedding Dimension of Projection Matrix for Column Attention Mechanism'
    )
    parser.add_argument(  # 投影矩阵采样方法
        '--method',
        default='learnable',
        type=str,
        help=f'Downsampling Methods for Projection Matrix'
    )
    return parser
